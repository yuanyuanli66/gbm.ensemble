#------- set path ---------
tb_loc="~/tb/po/xgboost_po/XgboostTumorPurityDemo/"        # code path
db_loc="~/tb/po/xgboost_po/XgboostTumorPurityDemo/input/"  # input path
gb_loc="~/tb/po/xgboost_po/XgboostTumorPurityDemo/output/" # output path
...
#   - TCGA RNAseq followed by single cell
